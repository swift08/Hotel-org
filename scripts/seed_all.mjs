  ...
  for (const biz of businesses) {
    ...
    const menuItems = [
      ...
      },
      {
        ...
        name: "Kadai Paneer",
        description:
          "Paneer cubes tossed with diced bell peppers & crushed coriander pepper masala.",
        price: 349,
        tags: ["veg", "spicy"],
        prep: 15,
      },
    ...
    function getDishImage(item) {
      ...
      if (catName.includes("soup") || name.includes("shorba"))
        return ["/images/dishes/tamatar_shorba.webp"];
      if (name.includes("paneer tikka") || name.includes("dahi ke kebab"))
        return ["/images/dishes/paneer_tikka.webp"];
      if (
        catName.includes("starter") &&
        (name.includes("chicken") || name.includes("seekh") || name.includes("fish"))
      )
        return ["/images/dishes/chicken_tikka.webp"];
      if (name.includes("tandoori chicken") || name.includes("malai chicken"))
        return ["/images/dishes/chicken_tikka.webp"];
      if (name.includes("butter chicken") || name.includes("makhani"))
      ...
      if (catName.includes("veg grav") || name.includes("paneer") || name.includes("dal"))
        return ["/images/dishes/paneer_butter_masala.webp"];
      if (catName.includes("south indian") || name.includes("dosa"))
        return ["/images/dishes/masala_dosa.webp"];
      if (catName.includes("bread") || name.includes("naan") || name.includes("roti"))
        return ["/images/dishes/garlic_naan.webp"];
      if (catName.includes("biryani") || name.includes("rice"))
        return name.includes("veg")
          ? ["/images/dishes/veg_biryani.webp"]
          : ["/images/dishes/mutton_biryani.webp"];
      if (catName.includes("beverage") || name.includes("lassi"))
        return ["/images/dishes/mango_lassi.webp"];
      if (catName.includes("dessert") || name.includes("jamun") || name.includes("cake"))
    ...
    const todayOrdersConfig = [
      // Completed & Paid Today (drives Today's Revenue, Orders Today, Avg Order Value)
      {
        ...
        amount: 1450,
        items: ["Butter Chicken Royale", "Butter Naan"],
      },
      {
        num: "ORD-TODAY-02",
        status: "completed",
        ...
        amount: 1820,
        items: ["Hyderabadi Dum Chicken Biryani", "Royal Mango Lassi"],
      },
      {
        num: "ORD-TODAY-03",
        status: "completed",
        ...
        amount: 2200,
        items: ["Royal Mutton Nalli Nihari", "Garlic Naan"],
      },
      {
        num: "ORD-TODAY-04",
        status: "completed",
        ...
        customer: "Ananya Rao",
        amount: 1150,
        items: ["Paneer Lababdar Special", "Truffle Garlic Naan"],
      },
      {
        num: "ORD-TODAY-05",
        status: "completed",
        ...
        amount: 2450,
        items: ["Awadhi Mutton Biryani", "Chocolate Lava Cake"],
      },
      {
        num: "ORD-TODAY-06",
        status: "completed",
        ...
        amount: 1680,
        items: ["Chicken Tikka Masala", "Butter Naan"],
      },
      {
        num: "ORD-TODAY-07",
        status: "completed",
        ...
        amount: 1350,
        items: ["Dal Makhani Special", "Jeera Rice"],
      },
      ...
      // New / Pending Today (drives NEW (PENDING) card count = 3)
      {
        ...
        amount: 890,
        items: ["Paneer Tikka Classic", "Garlic Naan"],
      },
      {
        num: "ORD-TODAY-09",
        status: "pending",
        ...
        customer: "Meera Iyer",
        amount: 1250,
        items: ["Chicken Seekh Kebab", "Royal Mango Lassi"],
      },
      {
        num: "ORD-TODAY-10",
        status: "pending",
        ...
        amount: 980,
        items: ["Kadai Paneer", "Butter Naan"],
      },
      ...
      // Preparing Today (drives KITCHEN QUEUE count = 3)
      {
        ...
        amount: 1540,
        items: ["Tandoori Chicken (Half)", "Truffle Garlic Naan"],
      },
      {
        num: "ORD-TODAY-12",
        status: "preparing",
        ...
        amount: 1750,
        items: ["Mutton Rogan Josh", "Lachha Paratha"],
      },
      {
        num: "ORD-TODAY-13",
        status: "preparing",
        ...
        amount: 1320,
        items: ["Ghee Roast Dosa", "Royal Mango Lassi"],
      },
      ...
      // Ready & Served Today
      {
        ...
        amount: 1100,
        items: ["Amritsari Fish Fry", "Butter Naan"],
      },
      {
        num: "ORD-TODAY-15",
        status: "served",
