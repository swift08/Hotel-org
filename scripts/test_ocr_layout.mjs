...
function runTests() {
  ...
  assertTest(
    "TEST 2: Dual Price Currency Symbols (Paneer Tikka ₹120 ₹200)",
    "Paneer Tikka ₹120 ₹200",
    (res) => {
      return (
        res.cleanName === "Paneer Tikka" &&
        res.variants.length === 2 &&
  ...
  assertTest(
    "TEST 3: Dish Brand Number Preservation (Chicken 65 ₹250)",
    "Chicken 65 ₹250",
    (res) => {
  ...
  assertTest(
    "TEST 4: Weight Number Preservation (Dal Fry 200g ₹180)",
    "Dal Fry 200g ₹180",
    (res) => {
      return res.cleanName === "Dal Fry 200g" && res.basePrice === 180 && res.variants.length === 0;
    },
  );

  // TEST 5: Triple Price Column (Quarter 90, Half 150, Full 280)
  assertTest(
    "TEST 5: Triple Price Column (Mutton Kebab 90 150 280)",
    "Mutton Kebab 90 150 280",
    (res) => {
      return (
