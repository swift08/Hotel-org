...
export async function seedCurryCourtyard() {
  ...
  if (!existingMem) {
    ...
    await supabase
      .from("memberships")
      .update({ is_active: true, role: "owner", branch_id: branchId })
  ...
  const menuItems = [
    // 1. Soups & Shorbas
    {
      category: "Soups & Shorbas",
      name: "Tamatar Dhaniya Shorba",
      description: "Infused ripe tomato broth spiced with fresh coriander roots & cumin.",
      price: 189,
      tags: ["veg"],
      prep: 10,
      images: ["/images/dishes/tamatar_shorba.webp"],
    },
    {
      category: "Soups & Shorbas",
      name: "Murgh Jahangiri Shorba",
      description: "Slow-simmered aromatic chicken bone broth with black pepper & ghee.",
      price: 229,
      tags: ["non_veg", "bestseller"],
      prep: 12,
    },
    {
      category: "Soups & Shorbas",
      name: "Sweet Corn Veg Soup",
      description: "Classic comforting soup with sweet corn kernels & finely diced veggies.",
      price: 179,
      tags: ["veg"],
      prep: 10,
    },
    {
      ...
      description: "Tangy & spicy chicken soup spiked with green chilies, soy & dark vinegar.",
      price: 209,
      tags: ["non_veg", "spicy"],
      prep: 12,
    },
    {
      category: "Soups & Shorbas",
      name: "Cream of Mushroom Shorba",
      description: "Velvety button mushroom extract tempered with garlic & mild Indian spices.",
      price: 199,
      tags: ["veg"],
      prep: 12,
    },
    ...
    // 2. Vegetarian Starters
    {
      ...
      description: "Fresh cottage cheese marinated in spiced hung yogurt & charred in clay oven.",
      price: 329,
      tags: ["veg", "bestseller"],
      prep: 15,
    },
    {
      category: "Vegetarian Starters",
      name: "Dahi Ke Kebab",
      description: "Crispy fried hung curd patties spiced with green chilies & fresh coriander.",
      price: 299,
    ...
    },
    {
      ...
      description: "Golden fried sweet corn tossed with chaat masala, onions & lime juice.",
      price: 269,
      tags: ["veg"],
      prep: 10,
    },
    {
      ...
      description: "Spiced spinach, pea & potato patties pan-seared to golden perfection.",
      price: 279,
      tags: ["veg"],
      prep: 12,
    },
    {
      ...
      description: "Crispy thin sliced okra tossed with tangy raw mango powder & pomegranate.",
      price: 249,
      tags: ["veg"],
      prep: 12,
    },
    {
      ...
      description: "Button mushrooms stuffed with spiced paneer, herbs & tandoori glaze.",
      price: 319,
      tags: ["veg"],
      prep: 15,
    },
    {
      category: "Vegetarian Starters",
      name: "Malai Broccoli Grill",
      description: "Fresh broccoli florets steeped in cashew, cream & cardamom marinade.",
      price: 349,
      tags: ["veg", "chef_special"],
      prep: 16,
    },
    {
      ...
      description: "Crispy rolls packed with stir-fried cabbage, carrots & bell peppers.",
      price: 259,
      tags: ["veg"],
      prep: 12,
    },
    ...
    // 3. Non-Vegetarian Starters
    {
      ...
      description: "Minced chicken blended with royal spices & roasted on iron skewers.",
      price: 389,
      tags: ["non_veg", "bestseller"],
      prep: 18,
    },
    {
      ...
      description: "Carom-seeded crispy batter fried fish fillets served with mint chutney.",
      price: 429,
      tags: ["non_veg", "spicy"],
      prep: 15,
    },
    {
      category: "Non-Vegetarian Starters",
      name: "Tandoori Bay Prawns",
      description: "Jumbo bay prawns steeped in spicy garlic chili marinade & charred.",
      price: 549,
      tags: ["non_veg", "chef_special"],
      prep: 15,
    },
    {
      category: "Non-Vegetarian Starters",
      name: "Chicken 65 Andhra Style",
      description: "Spicy fried chicken chunks tossed with curry leaves, mustard & green chilies.",
      price: 369,
      tags: ["non_veg", "spicy"],
      prep: 15,
    },
    {
      ...
      description: "Tender lamb chunks pan-roasted with freshly crushed black pepper & ghee.",
      price: 489,
      tags: ["non_veg", "bestseller"],
      prep: 20,
    },
    {
      ...
      description: "Melt-in-mouth minced mutton patties infused with 24 aromatic spices.",
      price: 459,
      tags: ["non_veg", "chef_special"],
      prep: 18,
    },
    {
      ...
      description: "Crispy chicken strips tossed in spicy red dragon chili sauce & cashews.",
      price: 379,
      tags: ["non_veg"],
      prep: 15,
    },
    {
      ...
      description: "Succulent prawns pan-fried with roasted Malabar peppercorns & onions.",
      price: 529,
      tags: ["non_veg", "spicy"],
      prep: 15,
    },
    ...
    {
      category: "Tandoori Grills & Kebabs",
      name: "Tandoori Chicken (Half)",
      description: "Bone-in chicken marinated overnight in Kashmiri chili, yogurt & mustard oil.",
      price: 449,
      tags: ["non_veg", "bestseller"],
      prep: 22,
    },
    {
      ...
      description: "Boneless chicken chunks marinated in cream, mozzarella cheese & cardamom.",
      price: 429,
      tags: ["non_veg"],
      prep: 18,
    },
    {
      ...
      description: "Tandoori chicken tikka flavored with pickled spices & mustard.",
      price: 419,
      tags: ["non_veg", "spicy"],
      prep: 18,
    },
    {
      ...
      description: "Cottage cheese marinated in mint, coriander & green chili marinade.",
      price: 339,
      tags: ["veg"],
      prep: 16,
    },
    {
      category: "Tandoori Grills & Kebabs",
      name: "Fish Tikka Ajwaini",
      description: "Boneless fish chunks marinated in carom seeds, ginger & lemon juice.",
      price: 469,
      tags: ["non_veg", "chef_special"],
      prep: 16,
    },
    {
      category: "Tandoori Grills & Kebabs",
      name: "Kasturi Murgh Kebab",
      description: "Chicken kebab wrapped in egg foam & perfumed with sun-dried fenugreek.",
      price: 439,
      tags: ["non_veg"],
      prep: 18,
    },
    {
      category: "Tandoori Grills & Kebabs",
      name: "Tandoori Veg Grill Platter",
      description: "Assortment of Paneer Tikka, Hara Bhara, Stuffed Mushroom & Broccoli.",
      price: 599,
      tags: ["veg", "bestseller"],
      prep: 20,
    },
    {
      category: "Tandoori Grills & Kebabs",
      name: "Royal Non-Veg Grill Platter",
      description: "Sizzling platter of Tandoori Chicken, Malai Tikka, Seekh Kebab & Fish Tikka.",
      price: 899,
      tags: ["non_veg", "chef_special"],
      prep: 24,
    },
    ...
    {
      category: "Chef's Signature Specials",
      name: "Curry Courtyard Butter Chicken",
      description: "Slow-cooked tandoori chicken simmered in silky velvet tomato & butter gravy.",
      price: 469,
      tags: ["non_veg", "bestseller"],
      prep: 18,
      images: ["/images/dishes/butter_chicken.webp"],
    },
    {
      category: "Chef's Signature Specials",
      name: "Royal Mutton Nalli Nihari",
      description: "Slow-cooked lamb shanks in rich spicy stew topped with fried ginger & mint.",
      price: 599,
      tags: ["non_veg", "chef_special"],
      prep: 25,
    },
    {
      ...
      description: "Cottage cheese in rich onion tomato cashew gravy topped with grated paneer.",
      price: 389,
      tags: ["veg", "bestseller"],
      prep: 16,
    },
    {
      category: "Chef's Signature Specials",
      name: "Murgh Musallam Special",
      description: "Whole roasted chicken stuffed with minced meat & boiled eggs in rich gravy.",
      price: 549,
      tags: ["non_veg", "chef_special"],
      prep: 25,
    },
    {
      category: "Chef's Signature Specials",
      name: "Dal Curry Courtyard Signature",
      description: "Black lentils slow-simmered 24 hours over wood charcoal with ghee.",
      price: 329,
      tags: ["veg", "bestseller"],
      prep: 15,
    },
    {
      category: "Chef's Signature Specials",
      name: "Dum Pukht Mutton Curry",
      description:
        "Sealed dough pot mutton curry cooked in its own juices & aromatic khada masala.",
      price: 569,
      tags: ["non_veg"],
      prep: 25,
    },
    ...
    {
      category: "North Indian Veg Gravies",
      name: "Dal Makhani",
      description: "Classic black lentils simmered overnight with tomato puree & fresh butter.",
      price: 299,
      tags: ["veg", "bestseller"],
      prep: 15,
    },
    {
      category: "North Indian Veg Gravies",
      name: "Kadai Paneer",
      description: "Paneer cubes tossed with diced bell peppers & crushed coriander pepper masala.",
      price: 349,
      tags: ["veg", "spicy"],
      prep: 15,
    },
    {
      category: "North Indian Veg Gravies",
      name: "Palak Paneer",
      description: "Creamy spinach puree tempered with roasted garlic & paneer cubes.",
      price: 339,
      tags: ["veg"],
      prep: 14,
    },
    {
      category: "North Indian Veg Gravies",
      name: "Malai Kofta",
      description: "Stuffed cottage cheese & potato dumplings in mild cashew gravy.",
      price: 359,
      tags: ["veg"],
      prep: 18,
    },
    {
      ...
      description: "Paneer cubes in sweet & mildly spiced creamy tomato butter sauce.",
      price: 359,
      tags: ["veg", "bestseller"],
      prep: 15,
    },
    {
      ...
      description: "Garden vegetables simmered in spicy Kolhapuri red chili gravy.",
      price: 319,
      tags: ["veg", "spicy"],
      prep: 15,
    },
    {
      category: "North Indian Veg Gravies",
      name: "Mushroom Kadhai Masala",
      description: "Fresh button mushrooms tossed with pounded spices & bell peppers.",
      price: 339,
      tags: ["veg"],
      prep: 15,
    },
    {
      ...
      description: "Crispy potato & cauliflower florets tossed with fresh ginger juliennes.",
      price: 289,
      tags: ["veg"],
      prep: 14,
    },
    {
      ...
      description: "Peshawari chickpea curry cooked with tea leaf extract & dried pomegranate.",
      price: 279,
      tags: ["veg"],
      prep: 14,
    },
    ...
    {
      category: "North Indian Non-Veg Gravies",
      name: "Chicken Tikka Masala",
      description: "Charcoal roasted chicken tikka cooked in chunky spiced onion tomato gravy.",
      price: 429,
      tags: ["non_veg", "spicy"],
      prep: 18,
    },
    {
      ...
      description: "Authentic Kashmiri lamb curry scented with ratanjot & fennel seeds.",
      price: 529,
      tags: ["non_veg", "bestseller"],
      prep: 22,
    },
    {
      category: "North Indian Non-Veg Gravies",
      name: "Kadhai Chicken",
      description: "Chicken on the bone tossed with fresh coriander, green chilies & capsicum.",
      price: 419,
      tags: ["non_veg"],
      prep: 20,
    },
    {
      ...
      description: "Chicken chunks simmered along with spiced chicken minced meat gravy.",
      price: 449,
      tags: ["non_veg", "chef_special"],
      prep: 20,
    },
    {
      category: "North Indian Non-Veg Gravies",
      name: "Handi Mutton Mughlai",
      description: "Slow-cooked mutton curry prepared in traditional clay handi.",
      price: 549,
      tags: ["non_veg"],
      prep: 24,
    },
    {
      category: "North Indian Non-Veg Gravies",
      name: "Fish Curry Malabari",
      description: "Tender fish fillets simmered in coconut milk, tamarind & mustard seed gravy.",
      price: 479,
      tags: ["non_veg"],
      prep: 18,
    },
    {
      ...
      description: "Boiled fried eggs simmered in onion tomato gravy with garud spices.",
      price: 269,
      tags: ["non_veg"],
      prep: 14,
    },
    {
      ...
      description: "100% boneless chicken tikka cooked in creamy tomato butter gravy.",
      price: 459,
      tags: ["non_veg", "bestseller"],
      prep: 18,
    },
    ...
    // 8. South Indian Specialties
    {
      ...
      description: "Crispy golden crepe roasted in pure Desi ghee served with chutney & sambar.",
      price: 169,
      tags: ["veg", "bestseller"],
      prep: 10,
    },
    {
      ...
      description: "Crispy dosa stuffed with spiced grated paneer & butter.",
      price: 199,
      tags: ["veg"],
      prep: 12,
    },
    {
      ...
      description: "Fiery Karaikudi style chicken curry flavored with black pepper & poppy seeds.",
      price: 429,
      tags: ["non_veg", "spicy"],
      prep: 18,
    },
    {
      ...
      description: "Crispy fried chicken tossed with fiery Guntur green chilies & curry leaves.",
      price: 389,
      tags: ["non_veg", "spicy"],
      prep: 15,
    },
    {
      ...
      description: "2 layered flaky Malabar parottas served with coconut vegetable kurma.",
      price: 249,
      tags: ["veg"],
      prep: 12,
    },
    {
      ...
      description: "Tender mutton chunks simmered in delicate coconut milk stew with peppercorns.",
      price: 519,
      tags: ["non_veg", "chef_special"],
      prep: 20,
    },
    ...
    {
      category: "Indian Tandoori Breads",
      name: "Butter Naan",
      description: "Soft leavened tandoori bread brushed with salted cream butter.",
      price: 79,
      tags: ["veg", "bestseller"],
      prep: 8,
    },
    {
      category: "Indian Tandoori Breads",
      name: "Garlic Naan",
      description: "Fluffy tandoori naan topped with finely minced garlic & fresh coriander.",
      price: 99,
      tags: ["veg", "bestseller"],
      prep: 8,
      images: ["/images/dishes/garlic_naan.webp"],
    },
    {
      category: "Indian Tandoori Breads",
      name: "Cheese Garlic Naan",
      description: "Stuffed with melted mozzarella & topped with roasted garlic flakes.",
      price: 129,
      tags: ["veg", "chef_special"],
      prep: 10,
    },
    {
      ...
      description: "Unleavened whole wheat flatbread baked in clay oven.",
      price: 49,
      tags: ["veg"],
      prep: 6,
    },
    {
      ...
      description: "Whole wheat tandoori roti brushed with Desi ghee.",
      price: 59,
      tags: ["veg"],
      prep: 6,
    },
    {
      category: "Indian Tandoori Breads",
      name: "Lachha Paratha",
      description: "Multi-layered flaky wheat bread brushed with butter.",
      price: 99,
      tags: ["veg"],
      prep: 10,
    },
    {
      category: "Indian Tandoori Breads",
      name: "Missi Roti",
      description: "Gram flour dough tempered with carom seeds, onions & green chili.",
      price: 59,
      tags: ["veg"],
      prep: 8,
    },
    {
      category: "Indian Tandoori Breads",
      name: "Amritsari Stuffed Paneer Kulcha",
      description: "Crispy kulcha stuffed with spiced cottage cheese & potatoes.",
      price: 139,
      tags: ["veg", "bestseller"],
      prep: 12,
    },
    {
      category: "Indian Tandoori Breads",
      name: "Pudina Paratha",
      description: "Multi-layered whole wheat bread sprinkled with dried mint powder.",
      price: 89,
      tags: ["veg"],
      prep: 8,
    },
    ...
    {
      category: "Royal Biryanis & Rice",
      name: "Hyderabadi Dum Chicken Biryani",
      description: "Long grain basmati rice layered with marinated chicken & fried onions.",
      price: 399,
      tags: ["non_veg", "bestseller"],
      prep: 20,
    },
    {
      ...
      description: "Succulent mutton cooked dum style with saffron scented basmati rice.",
      price: 479,
      tags: ["non_veg", "chef_special"],
      prep: 22,
      images: ["/images/dishes/mutton_biryani.webp"],
    },
    {
      category: "Royal Biryanis & Rice",
      name: "Royal Veg Dum Biryani",
      description: "Seasonal garden vegetables cooked with aromatic Biryani masala & rice.",
      price: 329,
      tags: ["veg"],
      prep: 18,
    },
    {
      ...
      description: "Basmati rice layered with tandoori paneer tikka & fried onions.",
      price: 359,
      tags: ["veg"],
      prep: 18,
    },
    {
      ...
      description: "Basmati rice dum cooked with boiled spiced eggs & kewra water.",
      price: 299,
      tags: ["non_veg"],
      prep: 16,
    },
    {
      category: "Royal Biryanis & Rice",
      name: "Jeera Rice",
      description: "Fragrant basmati rice tempered with cumin seeds & Desi ghee.",
      price: 199,
      tags: ["veg"],
      prep: 10,
    },
    ...
    {
      category: "Royal Biryanis & Rice",
      name: "Kashmiri Peas Pulao",
      description: "Basmati rice cooked with green peas, saffron & fried cashews.",
      price: 229,
      tags: ["veg"],
      prep: 12,
    },
    ...
    // 11. Beverages & Lassi
    {
      ...
      tags: ["veg", "bestseller"],
      prep: 5,
      images: ["/images/dishes/mango_lassi.webp"],
    },
    {
      category: "Beverages & Lassi",
      name: "Sweet Punjabi Lassi",
      description: "Traditional thick curd drink sweetened & topped with malai.",
      price: 129,
      tags: ["veg"],
      prep: 5,
    },
    {
      category: "Beverages & Lassi",
      name: "Masala Chaas",
      description: "Chilled buttermilk spiced with roasted cumin, black salt & mint.",
      price: 99,
      tags: ["veg"],
      prep: 5,
    },
    {
      ...
      description: "Refreshing fizzy soda with fresh lime juice & salt/sugar.",
      price: 119,
      tags: ["veg"],
      prep: 5,
    },
    {
      ...
      description: "Tangy lemonade spiked with chat masala, cumin & mint leaves.",
      price: 129,
      tags: ["veg"],
      prep: 5,
    },
    {
      ...
      description: "Refreshing mocktail with crushed mint, lime wedges & sparkling soda.",
      price: 159,
      tags: ["veg"],
      prep: 5,
    },
    {
      ...
      description: "Thick espresso blend topped with vanilla ice cream scoop.",
      price: 169,
      tags: ["veg"],
      prep: 5,
    },
    {
      category: "Beverages & Lassi",
      name: "Shahi Dry Fruit Lassi",
      description: "Thick sweet lassi topped with saffron strands & chopped almonds/pistachios.",
      price: 179,
      tags: ["veg", "chef_special"],
      prep: 5,
    },
    ...
    // 12. Desserts & Sweets
    {
      ...
      description: "Soft hot milk solids soaked in rose syrup served with vanilla ice cream.",
      price: 169,
      tags: ["veg", "bestseller"],
      prep: 5,
      images: ["/images/dishes/gulab_jamun.webp"],
    },
    {
      category: "Desserts & Sweets",
    ...
    },
    {
      ...
      description: "Rich carrot pudding cooked with milk, ghee, khoya & dry fruits.",
      price: 169,
      tags: ["veg"],
      prep: 8,
    },
    {
      ...
      description: "Crispy fried bread soaked in saffron rabri topped with pistachios.",
      price: 189,
      tags: ["veg"],
      prep: 8,
    },
    {
      category: "Desserts & Sweets",
      name: "Matka Kulfi Malai",
      description: "Traditional earthen pot Indian ice cream flavored with cardamom & saffron.",
      price: 149,
      tags: ["veg", "bestseller"],
      prep: 5,
    },
    {
      ...
      description: "Warm chocolate brownie served on a hot iron plate with vanilla scoop & fudge.",
      price: 219,
      tags: ["veg"],
      prep: 8,
    },
  ...
  function getDishImage(item) {
    ...
    if (
      category.includes("non-veg starter") ||
    ...
    if (
      category.includes("non-veg gravy") ||
      name.includes("curry") ||
      name.includes("rogan") ||
