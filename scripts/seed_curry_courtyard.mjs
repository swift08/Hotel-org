...
export async function seedCurryCourtyard() {
  ...
  const menuItems = [
    // 1. Soups & Shorbas
    { category: "Soups & Shorbas", name: "Tamatar Dhaniya Shorba", description: "Infused ripe tomato broth spiced with fresh coriander roots & cumin.", price: 189, tags: ["veg"], prep: 10, images: ["/images/dishes/tamatar_shorba.webp"] },
    ...
    { category: "Chef's Signature Specials", name: "Curry Courtyard Butter Chicken", description: "Slow-cooked tandoori chicken simmered in silky velvet tomato & butter gravy.", price: 469, tags: ["non_veg", "bestseller"], prep: 18, images: ["/images/dishes/butter_chicken.webp"] },
    ...
    { category: "Indian Tandoori Breads", name: "Garlic Naan", description: "Fluffy tandoori naan topped with finely minced garlic & fresh coriander.", price: 99, tags: ["veg", "bestseller"], prep: 8, images: ["/images/dishes/garlic_naan.webp"] },
    ...
    { category: "Royal Biryanis & Rice", name: "Awadhi Mutton Biryani", description: "Succulent mutton cooked dum style with saffron scented basmati rice.", price: 479, tags: ["non_veg", "chef_special"], prep: 22, images: ["/images/dishes/mutton_biryani.webp"] },
    ...
    // 11. Beverages & Lassi
    { category: "Beverages & Lassi", name: "Royal Mango Lassi", description: "Creamy yogurt drink blended with sweet Alphonso mango pulp.", price: 149, tags: ["veg", "bestseller"], prep: 5, images: ["/images/dishes/mango_lassi.webp"] },
    ...
    // 12. Desserts & Sweets
    { category: "Desserts & Sweets", name: "Gulab Jamun with Ice Cream", description: "Soft hot milk solids soaked in rose syrup served with vanilla ice cream.", price: 169, tags: ["veg", "bestseller"], prep: 5, images: ["/images/dishes/gulab_jamun.webp"] },
